import { Component, Input, OnInit,AfterViewInit,AfterContentInit ,NgZone} from '@angular/core';
...
export class DetailComponent implements OnInit,AfterViewInit,AfterContentInit {
  ...
  constructor(private ngZone:NgZone, private likesApi:LikesApi, private postApi:PostApi, private routeParams:RouteParams, private domService:DomSanitizationService, private titleService:Title, public global:Global) {
